...
class Portfolio(models.Model):
    ...
    def update_portfolio_stats(self):
        """
        Updates the portfolio's total value, asset count, and transaction count.
        """
...
class Transaction(models.Model):
    ...
    def save(self, *args, **kwargs):
        """
        Overridden save method to update asset values after a transaction is saved.
        """
        super().save(*args, **kwargs)
    ...
    def delete(self, *args, **kwargs):
        """
        Overridden delete method to update asset values after a transaction is deleted.
        """
    ...
    def update_asset_values(self):
        """
        Updates the total quantity, average price, and total value of an asset 
