...
class LoginRequiredMiddleware(MiddlewareMixin):
    ...
    specific parts of the application, such as the admin panel and operations.
    Handles redirects for login and unauthorized access based on user permissions.
    """
    ...
    def process_view(self, request, view_func, view_args, view_kwargs):
        ...
        if not request.user.is_authenticated:
            ...
            allowed_urls = [
                ...
                'home', 'custom_401', 'custom_404', 'wireframes', 'account_reset_password_done',
        ...
        # Restrict access to the /operations/ section for staff and superusers only
